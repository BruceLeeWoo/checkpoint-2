...
* Edit Component
  ...
  * look up componentWillReceiveProps
    * Use a prop that has the array of your models
    * Use a parameter from the route path /:id to find the model to show
    * Assign the model to state
    * Assign the value of the text boxes to be the appropriate state
  * onSubmit call a prop function called updateThing(thing), send in the state
